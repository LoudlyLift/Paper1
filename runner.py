...
parser.add_argument('algorithm', choices=['one', 'smart', 'const', 'local', 'LOCAL', 'offload', 'OFFLOAD', 'conventional', 'optimal'])
...
if args.algorithm == 'smart':
    ...
    w = algOptimal_world.algOptimal_world(s)
